        ...
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="text-gray-400">
                    ...
                    &nbsp;&middot;&nbsp;
                    <span>{{ $game['involvedCompany'] }}</span>
                    &nbsp;&middot;&nbsp;
                    <span>
                        {{ $game['platforms'] }}
                    </span>
                ...
                <div class="flex flex-wrap items-center mt-8 mt-8">
                    ...
                    <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                        ...
                        @if($game['social']['insta'])
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                                <a href="{{ $game['social']['insta']['url'] }}" class="hover:text-gray-400">
                ...
                <div class="mt-12">
                    <x-modal title="Trailer" type="warning">
                        ...
                        <x-slot name="trigger">
                            <a href="" @click.prevent="on = true" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
                            <svg class="w-6 fill-current" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"></path><path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
                        ...
                        <template x-if="on">
                            <div class="responsive-container">
                                <iframe width="560"
                                    height="315"
                                    class="responsive-iframe w-full h-full"
                                    src="{{$game['trailer']}}" style="border: 0" allow="autoplay;encrypted-media" allowfullscreen></iframe>
                            </div>
                        </template>
